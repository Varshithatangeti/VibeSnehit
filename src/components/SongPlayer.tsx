...
import { Download, Pause, Play, Volume2, VolumeX, SkipBack, SkipForward } from 'lucide-react'
...
const SongPlayer: React.FC<SongPlayerProps> = ({ song }) => {
  ...
  return (
    <div className="rounded-xl bg-background shadow-lg p-4 space-y-4">
      <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        <div className="flex-1 min-w-0 text-center sm:text-left">
          <h2 className="text-xl font-bold text-primary truncate">{song.name}</h2>
          <p className="text-muted-foreground text-sm">{song.album.name}</p>
        </div>
